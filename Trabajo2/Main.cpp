...
int main() {
    ...
    string base_dir = "Constructivo";
    string output_dir1 = base_dir + "/LocalSearch1B";
    string output_dir2 = base_dir + "/LocalSearch1F";
    ...
    for (int i = 1; i <= 18; ++i) {
        ...
        vector<Ruta> rutas_optimizadasBest = local_search_2opt_best(solucion_inicial, instancia_problema);
        ...
        vector<Ruta> rutas_optimizadasFirst = local_search_2opt_first(solucion_inicial, instancia_problema);
    ...
    output_dir1 = base_dir + "/LocalSearch3B";
    output_dir2 = base_dir + "/LocalSearch3F";
    ...
    for (int i = 1; i <= 18; ++i) {
        ...
        auto inicio1 = chrono::high_resolution_clock::now();
        vector<Ruta> rutas_optimizadasBest = local_search_relocate_best(solucion_inicial, instancia_problema);
        auto fin1 = chrono::high_resolution_clock::now();
        double duracion1 = chrono::duration_cast<chrono::milliseconds>(fin1 - inicio1).count();
        
        auto inicio2 = chrono::high_resolution_clock::now();
        vector<Ruta> rutas_optimizadasFirst = local_search_relocate_first(solucion_inicial, instancia_problema);
        auto fin2 = chrono::high_resolution_clock::now();
        double duracion2 = chrono::duration_cast<chrono::milliseconds>(fin2 - inicio2).count();
    ...
    base_dir = "Grasp";
    output_dir1 = base_dir + "/LocalSearch1B";
    output_dir2 = base_dir + "/LocalSearch1F";
